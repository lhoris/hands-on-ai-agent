...
export async function runToolResultWorkflow(userInput, onStep) {
  ...
  onStep({ role: 'context', prefix: 'context:', text: 'sending tool result back to LLM...' });

  const finalPrompt = await loadPromptTemplate('02_answer_with_tool_result.txt', {
    userInput,
